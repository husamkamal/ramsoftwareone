...
Today, we are proud to offer a wide range of software development services, including mobile game development, web & app development, and system development. We are driven by a passion for innovation and excellence, and are committed to delivering the highest quality solutions to our clients.</p>
            ...
            <div className='references container'>
                ...
                <div className='projects grid-wrapper'>
                    <div className='box'><span className='details'>IT support for setpoint engineering 21/22</span><img alt='stpnt' rel='noopener noreferrer' src={Setpoint}/><Link className='link' href='https://set-point-engineering.business.site/' target='_blank'>go to SetPoint</Link></div>
                    <div className='box'><span className='details'>android game Berzerk ball</span><img alt='bzball' rel='noopener noreferrer' src={Berzerkball}/><Link className='link' href='https://play.google.com/store/apps/details?id=com.MoRa.BerZerkBall&hl=en_US/' target='_blank'>go to BerzerkBall</Link></div>
                    <div className='box'><span className='details'>Bomb war space war shooting game</span><img alt='bmbwar' rel='noopener noreferrer' src={Bombwar}/><Link className='link' href='https://play.google.com/store/apps/details?id=com.mora.bombwar&hl=en_US/' target='_blank'>go to BombWar</Link></div>
                    <div className='box'><span className='details'>car trading project web app</span><img alt='gdcar' rel='noopener noreferrer' src={Goodcar}/><Link className='link' href='https://play.google.com/store/apps/details?id=com.mora.bombwar&hl=en_US/' target='_blank'>go to GoodCar</Link></div>
